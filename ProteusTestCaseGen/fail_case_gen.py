...
def formau_func_args():
    args_list = []
    for _ in range(rand_num(1, 5)):
        args_list.append(rand_list_entry(all_var_types) + rand_list_entry(all_var_names))
        args = ', '.join(args_list)
    return args
...
def generate_fail_case():
    ...
    for _ in range(rand_num(1, 5)):
        ...
        function = "// Function" # define_func(formal_func_args(), define_block())
